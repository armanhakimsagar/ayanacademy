...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = mysqli_query($conn, "DELETE FROM about_us WHERE id = $delete_id");

    if ($delete_query) {
        header("Location: about-us.php?deleted=1");
        exit;
    } else {
        $error = "Delete failed.";
    }
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = mysqli_query($conn, "SELECT * FROM about_us WHERE id = $edit_id LIMIT 1");
    ...
    if ($description === '') {
        ...
        if ($id > 0) {
            ...
            if (mysqli_query($conn, $update)) {
                header("Location: about-us.php?updated=1");
                exit;
            } else {
                $error = "Update failed.";
            }
            ...
            if (mysqli_query($conn, $insert)) {
                header("Location: about-us.php?added=1");
                exit;
            } else {
                $error = "Insert failed.";
            }
...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Admin Panel | About Us" />
    <meta name="author" content="Starkology" />
    <meta name="description" content="About Us Management" />
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                  <div class="card-header">
                    <div class="card-title">
                      <?php echo $edit_mode ? 'Edit About Us' : 'Add About Us'; ?>
                    </div>
                  </div>
                  ...
                  <form action="" method="post">
                    ...
                    <div class="card-footer">
                      <button type="submit" name="submit_about_us" class="btn btn-primary">
              ...
              <div class="col-md-7">
                <div class="card card-primary card-outline mb-4">
                  <div class="card-header">
                    <div class="card-title">View About Us</div>
                  </div>
                  ...
                  <div class="card-body table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                      ...
                      <tbody>
                        <?php
                        $about_query = mysqli_query($conn, "SELECT * FROM about_us ORDER BY id DESC");
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a
                                href="about-us.php?edit_id=<?php echo $row['id']; ?>"
                                class="btn btn-success btn-sm"
                              >
                                Edit
                              </a>
                              <a
                                href="about-us.php?delete_id=<?php echo $row['id']; ?>"
