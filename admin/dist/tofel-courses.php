...
$error = "";
$edit_mode = false;
$upload_dir = 'uploads/tofel-courses/';
...
if (isset($_GET['delete_id'])) {
    ...
    $old_q = mysqli_query($conn, "SELECT course_image FROM tofel_courses WHERE id = $delete_id LIMIT 1");
    ...
    $delete_query = mysqli_query($conn, "DELETE FROM tofel_courses WHERE id = $delete_id");
    if ($delete_query) {
        header("Location: tofel-courses.php?deleted=1");
        exit;
    } else {
        $error = "Delete failed.";
    }
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = mysqli_query($conn, "SELECT * FROM tofel_courses WHERE id = $edit_id LIMIT 1");
...
if (isset($_GET['deleted'])) {
    $message = "TOFEL course deleted successfully.";
}
if (isset($_GET['added'])) {
    $message = "TOFEL course added successfully.";
}
if (isset($_GET['updated'])) {
    $message = "TOFEL course updated successfully.";
}
...
if (isset($_POST['submit_course'])) {
    ...
    if ($error === '') {
        ...
        if ($id > 0) {
            $update = "UPDATE tofel_courses SET
            ...
            if (mysqli_query($conn, $update)) {
                header("Location: tofel-courses.php?updated=1");
                exit;
            } else {
                $error = "Update failed.";
            }
        } else {
            $insert = "INSERT INTO tofel_courses (
                course_image,
                course_title,
                course_short_description,
                lecture_hour_details,
            ...
            if (mysqli_query($conn, $insert)) {
                header("Location: tofel-courses.php?added=1");
                exit;
            } else {
                $error = "Insert failed.";
            }
...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Admin Panel | TOFEL Courses" />
    <meta name="author" content="Starkology" />
    <meta name="description" content="TOFEL Courses Management" />
    ...
    <div class="app-wrapper">
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation" data-accordion="false" id="navigation">
              ...
              <li class="nav-item"><a href="ielts-courses.php" class="nav-link"><i class="nav-icon bi bi-journal-richtext"></i><p>IELTS Courses</p></a></li>
              <li class="nav-item"><a href="tofel-courses.php" class="nav-link active"><i class="nav-icon bi bi-journal-richtext"></i><p>TOFEL Courses</p></a></li>
              ...
              <li class="nav-item"><a href="faq.php" class="nav-link"><i class="nav-icon bi bi-question-circle"></i><p>FAQ</p></a></li>
      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">TOFEL Courses</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">TOFEL Courses</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="app-content">
          <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-footer">
                      ...
                      <?php if ($edit_mode) { ?><a href="tofel-courses.php" class="btn btn-secondary ms-2">Cancel</a><?php } ?>
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div class="col-md-7">
                <div class="card card-primary card-outline mb-4">
                  <div class="card-header"><div class="card-title">View TOFEL Courses</div></div>
                  <div class="card-body table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                      ...
                      <tbody>
                        <?php
                        $course_query = mysqli_query($conn, "SELECT * FROM tofel_courses ORDER BY id DESC");
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="tofel-courses.php?edit_id=<?php echo (int)$row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                              <a href="tofel-courses.php?delete_id=<?php echo (int)$row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this course?')">Delete</a>
                            </td>
                          </tr>
                        <?php
                            }
                        ...
                        ?>
                          <tr><td colspan="6" class="text-center">No TOFEL course found.</td></tr>
                        <?php } ?>
                      </tbody>
                    </table>
                  </div>
