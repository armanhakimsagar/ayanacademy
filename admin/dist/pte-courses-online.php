...
if (isset($_GET['delete_id'])) {
    ...
    $old_image = '';
    $old_image_query = mysqli_query($conn, "SELECT course_image FROM pte_courses_online WHERE id = $delete_id LIMIT 1");
    ...
    $delete_query = mysqli_query($conn, "DELETE FROM pte_courses_online WHERE id = $delete_id");
    ...
    if ($delete_query) {
        ...
        header("Location: pte-courses-online.php?deleted=1");
        exit;
    } else {
        $error = "Delete failed.";
    }
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = mysqli_query($conn, "SELECT * FROM pte_courses_online WHERE id = $edit_id LIMIT 1");
...
if (isset($_POST['submit_course'])) {
    ...
    if (
        ...
        if (isset($_FILES['course_image']) && !empty($_FILES['course_image']['name'])) {
            $upload_dir = '../../uploads/pte-courses-online/';
            ...
            if (!in_array($image_file_type, $allowed_types)) {
                ...
                if (move_uploaded_file($_FILES['course_image']['tmp_name'], $target_file)) {
                    $course_image = 'uploads/pte-courses-online/' . $file_name;
        ...
        if ($error === '') {
            ...
            if ($id > 0) {
                $update = "UPDATE pte_courses_online SET
                ...
                if (mysqli_query($conn, $update)) {
                    header("Location: pte-courses-online.php?updated=1");
                    exit;
                } else {
                    $error = "Update failed.";
                }
            } else {
                $insert = "INSERT INTO pte_courses_online (
                    course_title,
                    course_image,
                    course_short_description,
                    lecture_hour_details,
                ...
                if (mysqli_query($conn, $insert)) {
                    header("Location: pte-courses-online.php?added=1");
                    exit;
                } else {
                    $error = "Insert failed.";
                }
...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Admin Panel | PTE Courses Online" />
    <meta name="author" content="Starkology" />
    <meta name="description" content="PTE Courses Online Management" />
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="pte-courses-online.php" class="nav-link active">
      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">PTE Courses (Online)</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">PTE Courses Online</li>
                </ol>
              </div>
            </div>
          </div>
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-footer">
                      ...
                      <?php if ($edit_mode) { ?>
                        <a href="pte-courses-online.php" class="btn btn-secondary">Cancel</a>
                      <?php } ?>
                    </div>
                  </form>
                </div>
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <div class="card-body table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                      ...
                      <tbody>
                        <?php
                        $course_query = mysqli_query($conn, "SELECT * FROM pte_courses_online ORDER BY id DESC");
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="pte-courses-online.php?edit_id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm">
                                Edit
                              </a>
                              <a
                                href="pte-courses-online.php?delete_id=<?php echo $row['id']; ?>"
