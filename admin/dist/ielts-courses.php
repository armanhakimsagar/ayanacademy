        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation" data-accordion="false" id="navigation">
              ...
              <li class="nav-item"><a href="ielts-courses.php" class="nav-link active"><i class="nav-icon bi bi-journal-richtext"></i><p>IELTS Courses</p></a></li>
              <li class="nav-item"><a href="tofel-courses.php" class="nav-link"><i class="nav-icon bi bi-journal-richtext"></i><p>TOFEL Courses</p></a></li>
