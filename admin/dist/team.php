            ...
            if (!isset($_FILES['image']) || $_FILES['image']['error'] != 0) {
                ...
                if (!in_array($ext, $allowed)) {
                    ...
                    if (move_uploaded_file($tmp_name, $new_name)) {
                        ...
                        $insert = "INSERT INTO team (image, name) VALUES ('$image_path', '$name')";
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                  <div class="card-header">
                    <div class="card-title">
                      <?php echo $edit_mode ? 'Edit Team Member' : 'Add Team Member'; ?>
                    </div>
                  </div>
              ...
              <div class="col-md-7">
                <div class="card card-primary card-outline mb-4">
                  <div class="card-header">
                    <div class="card-title">View Team</div>
                  </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a
                                href="team.php?edit_id=<?php echo $row['id']; ?>"
                                class="btn btn-success btn-sm"
                              >
                                Edit
                              </a>
                              <a
                                href="team.php?delete_id=<?php echo $row['id']; ?>"
